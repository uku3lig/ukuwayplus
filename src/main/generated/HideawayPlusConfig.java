...
public class HideawayPlusConfig extends ConfigWrapper<plus.hideaway.mod.feat.config.HideawayPlusConfigModel> {
    ...
    private HideawayPlusConfig() {
        super(plus.hideaway.mod.feat.config.HideawayPlusConfigModel.class);
    }

    private HideawayPlusConfig(Consumer<Jankson.Builder> janksonBuilder) {
        super(plus.hideaway.mod.feat.config.HideawayPlusConfigModel.class, janksonBuilder);
    }
